...
projpts <- function(x,
                    passyds = 25, passtds = 5, ints = -2, rushyds = 10, rushtds = 6, recs = 0.5,
                    recyds = 10, rectds = 6, twopts = 2, fumbles = -1, 
                    numofqb = 12, numofrb = 24, numofwr = 36, numofte = 12) {
